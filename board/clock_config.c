...
- {id: GPT1_CLK_ROOT.outFreq, value: 1 MHz}
- {id: GPT1_ipg_clk_highfreq.outFreq, value: 1 MHz}
...
- {id: CCM.CLOCK_ROOT14.DIV.scale, value: '24', locked: true}
- {id: CCM.CLOCK_ROOT15.DIV.scale, value: '24', locked: true}
